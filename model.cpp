...
mesh::mesh(aiMesh* aiMesh, const aiScene* scene, std::string directory){
...
std::vector<GLuint> mesh::loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string directory)
{
...
void mesh::loadMesh(aiMesh* aiMesh, const aiScene* scene, std::string directory){
